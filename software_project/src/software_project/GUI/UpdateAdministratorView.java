 ...
 * @author DELL
 */
public class UpdateAdministratorView extends javax.swing.JFrame {

    AdministratorController admin = new AdministratorController();


    /**
     * Creates new form UpdateAdministrator
     */
    public UpdateAdministratorView() {
        initComponents();
    }
    ...
    private void UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateActionPerformed
        if (!"".equals(UsernameText.getText()) && !"".equals(PasswordText.getText()) && !"".equals(IDText.getText())) {
            ...
            admin.showInfoDialog("PLEASE FILL ALL FIELDS...");
        }
    }
...
//    }                         }                         }//GEN-LAST:event_UpdateActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateAdministratorView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateAdministratorView().setVisible(true);
            }
        });
    }
